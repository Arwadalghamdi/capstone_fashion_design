      ...
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner">
          ...
          <div class="card">
              ...
              <!-- /Logo -->
              <h4 class="mb-2 text-center">Login as Designer</h4>
              <p class="mb-4 text-center">Welcome to Designer dashboard</p>

              <form id="formAuthentication" class="mb-3" action="{{route('designer.login.post')}}" method="POST">
                @csrf
                <div class="mb-3">
