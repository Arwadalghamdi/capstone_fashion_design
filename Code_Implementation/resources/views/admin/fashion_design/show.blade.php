...
<div class="container-xxl flex-grow-1 container-p-y">
   ...
   <div class="card">
      ...
      Fashion Design || {{ $fashion->title }}
         <a href="{{route('admin.fashions.index')}}" class="btn btn-danger float-end">
      ...
      <div class="card-body">
         ...
         <table class="table table-striped">
            <tbody>
               ...
               <tr>
                  <th>Designer</th>
                  <td>{{$fashion->designer?->name}}</td>
               </tr>
               <tr>
                  <th>Category</th>
                  <td>{{$fashion->category?->name}}</td>
               </tr>
               <tr>
                  <th>Image</th>
                  <td>
                     <img src="{{$fashion->image_path}}" style="width: 100%; height: 400px" alt="">
                  </td>
               </tr>
               <tr>
