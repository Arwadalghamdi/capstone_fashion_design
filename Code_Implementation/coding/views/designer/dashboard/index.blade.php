                                       ...
                                       <div class="card-title d-flex align-items-start justify-content-between">
                                          ...
                                          <div class="dropdown">
                                             ...
                                             <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt3">
                                                <a class="dropdown-item" href="{{route('admin.customers.index')}}">Read More</a>
                                             </div>
                                          </div>
                                       </div>
                                       ...
                                       <div class="card-title d-flex align-items-start justify-content-between">
                                          ...
                                          <div class="dropdown">
                                             ...
                                             <div class="dropdown-menu dropdown-menu-end" aria-labelledby="cardOpt4">
                                                <a class="dropdown-item" href="{{route('admin.designers.index')}}">Read More</a>
                                             </div>
                                          </div>
                                       </div>
                                       ...
                                       <div class="card-title d-flex align-items-start justify-content-between">
                                          ...
                                          <div class="dropdown">
                                             ...
                                             <div class="dropdown-menu" aria-labelledby="cardOpt1">
                                                <a class="dropdown-item" href="{{route('admin.fashions.index')}}">Read More</a>
                                             </div>
                                          </div>
                                       </div>
