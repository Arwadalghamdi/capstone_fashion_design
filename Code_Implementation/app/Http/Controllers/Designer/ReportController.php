...
class ReportController extends Controller
{
    ...
    public function fashions()
    {
        $topDesigns = FashionDesign::join('order_item', 'product.product_id', '=', 'order_item.product_id')
            ...
            ->where('product.designer_id', auth('designers')->id()) // Specify table for designer_id
    ...
    {
        $topCustomers = Order::where('designer_id', auth('designers')->id())
