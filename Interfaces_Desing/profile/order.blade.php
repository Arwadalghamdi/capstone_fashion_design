                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($rev = $order->reviews()->where('fashion_design_id', $item->fashion_design_id)->first())
                                        @foreach(range(1,5) as $r)
                                        <i class="fa fa-star{{$rev->rating >= $r ? '' : '-o'}} text-warning"></i>
                                        @endforeach
                                        @else
                                        <a href="{{route('customer.profile.review', $order->id)}}?fashion={{$item->fashion_design_id}}" class="n-link">Review Now</a>
                                        @endif
                                    </td>
                                </tr>
                                @empty
                ...
                <div class="col-lg-4">
                    ...
                    <div class="cart__total">
                        ...
                        <ul>
                            ...
                            <li>Payment <span>{{ trans('customer.pay_methods.' . $order->payment?->payment_method) }}</span></li>
                            <li>Status <span>{{ trans('customer.payment_status.' . $order->payment?->payment_status) }}</span></li>
                        </ul>
